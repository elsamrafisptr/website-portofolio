        ...
        <>
            <div className="mt-6">
                ...
                <div className="mt-4 overflow-hidden relative h-20 w-full">
                    <div className="flex absolute left-0 justify-center items-center gap-4 h-full w-[700%] lg:w-[200%] animate-[scrollLeft_24s_linear_infinite] lg:animate-[scrollLeft_24s_linear_infinite]">
                ...
                <div className="overflow-hidden relative mt-2 h-16 w-full px-6">
                    <div className="flex absolute left-0 justify-center items-center gap-4 h-full w-[700%] lg:w-[200%] animate-[scrollRight_24s_linear_infinite] lg:animate-[scrollRight_24s_linear_infinite]">
                        {inputsSkills.map((input) => (
                            <div
                                key={input.id}
